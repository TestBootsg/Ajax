...
async def next_page(bot, query):
    ...
    if int(req) not in [query.from_user.id, 0]:
        return await query.answer("Hey Friend, Don't take others property...😅", show_alert=True)
    try:
        offset = int(offset)
    except:
        offset = 0
    ...
    if not search:
        await query.answer("Your time has ended...😴", show_alert=True)
        return
    ...
    btn.insert(0,
        [
            ...
            InlineKeyboardButton('ᴍᴏʀᴇ ɪɴꜰᴏ', url='https://t.me/MultiiFliX/3'),
...
async def advantage_spoll_choker(bot, query):
    ...
    if not movies:
        return await query.answer("Your time has ended...😴", show_alert=True)
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('💠 UᎮDΛTΞS 💠', url='https://t.me/MultiiFliX')
        ], [
